...
<body class="bg-slate-50 text-slate-900 flex min-h-screen">
    ...
    <a href="/admin"
        class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition {{ request()->is('admin') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-800' }}">
        <svg class="w-5 h-5 {{ request()->is('admin') ? 'text-indigo-300' : 'text-indigo-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
     ...
     <a href="{{ route('admin.categories.index') }}"
        class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition {{ request()->routeIs('admin.categories.*') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-800' }}">
    ...
    <a href="{{ route('admin.events.index') }}"
        class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition {{ request()->routeIs('admin.events.*') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-800' }}">
    ...
    <a href="{{ route('admin.partners.index') }}"
        class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition {{ request()->routeIs('admin.partners.*') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-800' }}">
    ...
    <a href="/admin/transactions"
        class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition {{ request()->is('admin/transactions*') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-800' }}">
        <svg class="w-5 h-5 {{ request()->is('admin/transactions*') ? 'text-indigo-300' : 'text-indigo-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
